...
\section{Education}
  \resumeSubHeadingListStart
    \resumeSubheadingWithAdditional
      ...
      {Master of Quantitative Finance and Risk Management (GPA 110/110 - expected)}{Sep 2023 -- Sep 2024}{\underline{Thesis:} Application of the Heath-Jarrow-Morton Framework to Pricing Interest Rate Derivatives}{\underline{Relevant Courses:} Term Structure Modelling, Stochastic Calculus, Derivatives, Econometrics}
    \resumeSubheadingWithAdditional
...
\section{Experience}
  \resumeSubHeadingListStart
	...
	{Securities Valuation Analyst}{Jun 2024 -- present}
	\resumeItemListStart
	\resumeItem{Utilized quantitative models to price securities with varying levels of liquidity, ensuring precise and comprehensive valuations in dynamic market conditions}
	\resumeItem{Ensured accurate and timely pricing of European corporate bonds and money market instruments across multiple daily snapshots}
...
\begin{tabularx}{0.96\textwidth} { 
  ...
  \small{\textbf{Languagues}: Croatian (Native), English (Fluent), Spanish (Fluent), German (Conversational)}
\end{tabularx}
\end{center}
...
\small{\textbf{Intermediate proficiency}: Tableau, Powerpoint, Word} & \small{\hspace{3pt}\textbf{Bloomberg Terminal}: Intermediate knowledge} \\
\end{tabularx}
\end{center}
